...
var addLightboxClass = function addLightboxClass(item) {
  if (item.classList) {
...
var closeOnEsc = function closeOnEsc(event) {
  if (event.keyCode === 27) {
    var openLightboxes = document.querySelector('.lightbox--opened');
...
var navOnArrowKey = function navOnArrowKey(event) {
  var currentlyActive = document.querySelector('.lightbox--opened');
  var previousEl = [];
